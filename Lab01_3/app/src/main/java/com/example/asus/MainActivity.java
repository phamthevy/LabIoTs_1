...
public class MainActivity extends Activity {
    ...
    private static final double MAX_ACTIVE = 30;
    private static final double PULSE_PERIOD_MS = 30;   // Frequency of 50Hz (1000/20)

    private static double Change_step = 0.1;
